...
namespace Pub.Class {
    ...
    /// 
    /// </summary>
    public class Oracle : IDbProvider {
        /// <summary>
        /// OracleClient实例
        /// </summary>
        /// <returns>OracleClient实例</returns>
        public DbProviderFactory Instance() { return OracleClientFactory.Instance; }
        /// <summary>
        /// 返回刚插入记录的自增ID值
        /// </summary>
        /// <returns>SQL</returns>
        ...
        public void DeriveParameters(IDbCommand cmd) {
            if ((cmd as OracleCommand) != null) OracleCommandBuilder.DeriveParameters(cmd as OracleCommand);
        }
        /// <summary>
        /// 创建SQL参数
        /// </summary>
        ...
        public DbParameter MakeParam(string ParamName, DbType DbType, Int32 Size) {
            if (Size > 0) return new OracleParameter(ParamName, (OracleType)DbType, Size);
            return new OracleParameter(ParamName, (OracleType)DbType);
        }

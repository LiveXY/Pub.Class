...
namespace Pub.Class.Linq {
    ...
    public interface IOrderedEnumerable<TElement> : IEnumerable<TElement>, IEnumerable {
        /// <summary>根据某个键对 <see cref="T:Pub.Class.Linq.IOrderedEnumerable`1" /> 的元素执行后续排序。</summary>
        /// <returns>一个 <see cref="T:Pub.Class.Linq.IOrderedEnumerable`1" />，其元素按键进行排序。</returns>

...
namespace Pub.Class.Linq {
    ...
    public static partial class Enumerable {
        ...
        /// <returns>一个 <see cref="T:Pub.Class.Linq.IOrderedEnumerable`1" />，其元素按键排序。</returns>
        ...
        /// <returns>一个 <see cref="T:Pub.Class.Linq.IOrderedEnumerable`1" />，将根据键按降序对其元素进行排序。</returns>
        /// <param name="source">一个要排序的值序列。</param>
        /// <param name="keySelector">用于从元素中提取键的函数。</param>
        /// <typeparam name="TSource">
        ///   <paramref name="source" /> 中的元素的类型。</typeparam>
        ...
        /// <returns>一个 <see cref="T:Pub.Class.Linq.IOrderedEnumerable`1" />，其元素按键排序。</returns>
        /// <param name="source">一个 <see cref="T:Pub.Class.Linq.IOrderedEnumerable`1" />，包含要排序的元素。</param>
        ...
        /// <returns>在 C# 中为 IEnumerable&lt;IGrouping&lt;TKey, TSource&gt;&gt;，或者在 Visual Basic 中为 IEnumerable(Of IGrouping(Of TKey, TSource))，其中每个 <see cref="T:Pub.Class.Linq.IGrouping`2" /> 对象都包含一个对象序列和一个键。</returns>
        ...
        /// <returns>在 C# 中为 IEnumerable&lt;IGrouping&lt;TKey, TSource&gt;&gt;，或者在 Visual Basic 中为 IEnumerable(Of IGrouping(Of TKey, TSource))，其中每个 <see cref="T:Pub.Class.Linq.IGrouping`2" /> 对象都包含一个对象集合和一个键。</returns>
        /// <param name="source">要对其元素进行分组的 <see cref="T:System.Collections.Generic.IEnumerable`1" />。</param>
        /// <param name="keySelector">用于提取每个元素的键的函数。</param>
        ...
        /// <returns>在 C# 中为 IEnumerable&lt;IGrouping&lt;TKey, TElement&gt;&gt;，或者在 Visual Basic 中为 IEnumerable(Of IGrouping(Of TKey, TElement))，其中每个 <see cref="T:Pub.Class.Linq.IGrouping`2" /> 对象都包含一个类型为 <paramref name="TElement" /> 的对象集合和一个键。</returns>
        /// <param name="source">要对其元素进行分组的 <see cref="T:System.Collections.Generic.IEnumerable`1" />。</param>
        /// <param name="keySelector">用于提取每个元素的键的函数。</param>
        /// <param name="elementSelector">用于将每个源元素映射到 <see cref="T:Pub.Class.Linq.IGrouping`2" /> 中的元素的函数。</param>
        /// <typeparam name="TSource">
        ///   <paramref name="source" /> 中的元素的类型。</typeparam>
        /// <typeparam name="TKey">
        ///   <paramref name="keySelector" /> 返回的键的类型。</typeparam>
        /// <typeparam name="TElement">
        ///   <see cref="T:Pub.Class.Linq.IGrouping`2" /> 中的元素的类型。</typeparam>
        /// <exception cref="T:System.ArgumentNullException">
        ...
        /// <typeparam name="TKey">
        ///   <paramref name="keySelector" /> 返回的键的类型。</typeparam>
        /// <typeparam name="TElement">每个 <see cref="T:Pub.Class.Linq.IGrouping`2" /> 中的元素的类型。</typeparam>
        /// <typeparam name="TResult">
        ///   <paramref name="resultSelector" /> 返回的结果值的类型。</typeparam>
        ...
        /// <summary>根据指定的键选择器函数，从 <see cref="T:System.Collections.Generic.IEnumerable`1" /> 创建一个 <see cref="T:Pub.Class.Linq.Lookup`2" />。</summary>
        /// <returns>一个包含键和值的 <see cref="T:Pub.Class.Linq.Lookup`2" />。</returns>
        /// <param name="source">要从其创建 <see cref="T:Pub.Class.Linq.Lookup`2" /> 的 <see cref="T:System.Collections.Generic.IEnumerable`1" />。</param>
        /// <param name="keySelector">用于从每个元素中提取键的函数。</param>
        /// <typeparam name="TSource">
        ///   <paramref name="source" /> 中的元素的类型。</typeparam>
        /// <typeparam name="TKey">
        ...
        /// <summary>根据指定的键选择器函数和键比较器，从 <see cref="T:System.Collections.Generic.IEnumerable`1" /> 创建一个 <see cref="T:Pub.Class.Linq.Lookup`2" />。</summary>
        /// <returns>一个包含键和值的 <see cref="T:Pub.Class.Linq.Lookup`2" />。</returns>
        /// <param name="source">要从其创建 <see cref="T:Pub.Class.Linq.Lookup`2" /> 的 <see cref="T:System.Collections.Generic.IEnumerable`1" />。</param>
        /// <param name="keySelector">用于从每个元素中提取键的函数。</param>
        /// <param name="comparer">一个用于对键进行比较的 <see cref="T:System.Collections.Generic.IEqualityComparer`1" />。</param>
        ...
        /// <summary>根据指定的键选择器和元素选择器函数，从 <see cref="T:System.Collections.Generic.IEnumerable`1" /> 创建一个 <see cref="T:Pub.Class.Linq.Lookup`2" />。</summary>
        /// <returns>一个 <see cref="T:Pub.Class.Linq.Lookup`2" />，包含从输入序列中选择的类型为 <paramref name="TElement" /> 的值。</returns>
        /// <param name="source">要从其创建 <see cref="T:Pub.Class.Linq.Lookup`2" /> 的 <see cref="T:System.Collections.Generic.IEnumerable`1" />。</param>
        /// <param name="keySelector">用于从每个元素中提取键的函数。</param>
        /// <param name="elementSelector">用于从每个元素产生结果元素值的转换函数。</param>
        /// <typeparam name="TSource">
        ...
        /// <summary>根据指定的键选择器函数、比较器和元素选择器函数，从 <see cref="T:System.Collections.Generic.IEnumerable`1" /> 创建一个 <see cref="T:Pub.Class.Linq.Lookup`2" />。</summary>
        /// <returns>一个 <see cref="T:Pub.Class.Linq.Lookup`2" />，包含从输入序列中选择的类型为 <paramref name="TElement" /> 的值。</returns>
        /// <param name="source">要从其创建 <see cref="T:Pub.Class.Linq.Lookup`2" /> 的 <see cref="T:System.Collections.Generic.IEnumerable`1" />。</param>
        /// <param name="keySelector">用于从每个元素中提取键的函数。</param>
        /// <param name="elementSelector">用于从每个元素产生结果元素值的转换函数。</param>

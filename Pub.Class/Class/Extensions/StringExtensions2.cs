...
namespace Pub.Class {
    ...
    public static class StringExtensions {
        ...
        /// 左截字符串
        /// </summary>
        /// <param name="string">string扩展</param>
        ...
        /// </summary>
        /// <typeparam name="T">源类型</typeparam>
        /// <param name="serializedObject">string扩展</param>
        /// <returns></returns>
        ...
        /// ToBool
        /// </summary>
        /// <param name="Expression">string扩展</param>
        /// <param name="defValue"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 动态加载bin目录下的DLL类 Activator.CreateInstance CACHE
        /// </summary>
        /// <param name="dllFileName">bin目录下的dll文件名 不含路径</param>
        ...
        /// 动态加载bin目录下的DLL类 Activator.CreateInstance CACHE
        /// </summary>
        /// <param name="classNameAndNameSpace">命名空间.类名,命名空间</param>
        /// <returns></returns>
        ...
        ///// <summary>
        ///// 动态加载bin目录下的DLL类 IL + CACHE 多次调用使用
        ///// </summary>
        ///// <param name="dllFileName">bin目录下的dll文件名 不含路径</param>
        ///// <param name="className">命名空间和类名</param>
        ///// <returns></returns>
        ...
        /// </summary>
        /// <param name="this">object扩展</param>

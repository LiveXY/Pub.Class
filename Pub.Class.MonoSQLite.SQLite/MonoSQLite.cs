...
namespace Pub.Class {
    ...
    ///
    /// 修改纪录
    ///     2011.12.21 版本：1.0 livexy 创建此类
    ///
    /// </summary>
    public class MonoSQLite : IDbProvider {
        /// <summary>
        /// MySql实例
        /// </summary>
        /// <returns>MySql实例</returns>
		public DbProviderFactory Instance() { return SqliteFactory.Instance; }
        /// <summary>
        /// 返回刚插入记录的自增ID值
        /// </summary>
        /// <returns>SQL</returns>
        ...
        public void DeriveParameters(IDbCommand cmd) {
            //if ((cmd as SQLiteCommand) != null) System.Data.OleDb.OleDbCommandBuilder.DeriveParameters(cmd as SQLiteCommand);
        }
        /// <summary>
        /// 创建SQL参数
        /// </summary>
        ...
        public DbParameter MakeParam(string ParamName, DbType DbType, Int32 Size) {
            if (Size > 0) return new SqliteParameter(ParamName, DbType, Size);
            return new SqliteParameter(ParamName, DbType);
        }

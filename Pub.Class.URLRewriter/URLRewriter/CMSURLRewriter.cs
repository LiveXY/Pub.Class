...
namespace Pub.Class {
    ...
    ///     
    /// </summary>
    public class CMSURLRewriter : System.Web.IHttpModule {
        /// <summary>
        /// 实现接口的Init方法
        /// </summary>
        ...
        private void RewriterUrl_BeginRequest(object sender, EventArgs e) {
            ...
            RewriterRules rules = CMSURLData.Rules;
            //("0|" + rules.Count).ToFile("e:\\log.txt", Encoding.UTF8, false);
            for (int i = 0; i < rules.Count; i++) {
                ...
                //("1|" + matchUrl + "|" + requestPath).ToFile("e:\\log.txt", Encoding.UTF8, false);
                if (re.IsMatch(requestPath)) {
                    ...
                    //("2|" + actionUrl).ToFile("e:\\log.txt", Encoding.UTF8, false);

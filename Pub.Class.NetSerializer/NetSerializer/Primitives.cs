...
namespace NetSerializer {
    public static class Primitives {
        ...
        //public static void WritePrimitive<T>(Stream stream, T value) {
        //    NetSerializer.Serializer.Serialize(stream, value);
        //}

        //public static void ReadPrimitive<T>(Stream stream, out T value) {
        //    var kvpArray = (T)NetSerializer.Serializer.Deserialize(stream);
        //    value = kvpArray;
        //}
    }
}
